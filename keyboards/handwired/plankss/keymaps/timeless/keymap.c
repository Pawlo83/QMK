...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [1] = LAYOUT_ortho_5x12( 
        ...
        KC_LSFT,    TD(TD_NOO), TD(TD_NOO), KC_GRAVE, PL_MINS, PL_EQL,  KC_PAUS, KC_VOLD,        KC_MUTE,        KC_VOLU,        KC_BSLS, KC_LSFT,
        KC_LCTL,    KC_LGUI,    KC_LALT,    TG(3),    TG(4),   KC_SPC,  KC_SPC,  KC_TRNS,        KC_TRNS,        KC_RALT,        KC_RGUI, KC_RCTL
    ), 
    [2] = LAYOUT_ortho_5x12(
        KC_ESC,     KC_F1,      KC_F2,      KC_F3,    KC_F4,   KC_F5,   KC_F6,   KC_F7,          KC_F8,          KC_F9,          KC_F10,  KC_F11,
    ...
    [4] = LAYOUT_ortho_5x12(
       	KC_ESC,     KC_1,    KC_2,       KC_3,         KC_4,    KC_5,    KC_6,    KC_7,           KC_8,           KC_9,           KC_0,    TG(4),
       	KC_TAB,     PL_X,    PL_L,       PL_D,         PL_G,    PL_V,    PL_Q,    PL_F,           PL_O,           PL_U,           PL_SCLN, PL_QUOT,
       	KC_CAPS,    PL_N,    PL_R,       PL_T,         PL_S,    PL_Y,    PL_J,    PL_H,           PL_A,           PL_E,           PL_I,    KC_BSPC,
       	KC_LSFT,    PL_P,    PL_K,       PL_C,         PL_W,    PL_Z,    PL_B,    PL_M,           PL_COMM,        PL_DOT,         PL_SLSH, KC_RSFT,
       	KC_LCTL,    KC_LGUI, KC_LALT,    MO(1),        MO(1),   KC_SPC,  KC_SPC,  LT(1, KC_ENT),  LT(2, KC_TAB),  KC_RALT,        KC_RGUI, KC_RCTL
    ) 
};
