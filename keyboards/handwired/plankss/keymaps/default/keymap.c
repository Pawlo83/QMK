...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [1] = LAYOUT_ortho_5x12(
        ...
        KC_TAB,  KC_LCBR, KC_LPRN, KC_RPRN, KC_RCBR,  PL_PIPE, KC_PSCR, KC_MPRV,       KC_MPLY,       KC_MNXT, KC_F12,  KC_NO,
        KC_NO,   KC_LBRC, KC_QUOT, KC_DQUO, KC_RBRC,  KC_SCLN, KC_CAPS, KC_LEFT,       KC_UP,         KC_DOWN, KC_RGHT, KC_BSPC,
        KC_LSFT, TG(3),   KC_NO,   KC_GRAVE,PL_MINS,  PL_EQL,  KC_PAUS, KC_VOLD,       KC_MUTE,       KC_VOLU, KC_BSLS, KC_LSFT,
